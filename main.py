...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Prompt history layout
        history_layout = QHBoxLayout()
        self.history_label = QLabel("History:")
        self.history_combo = QComboBox()
        self.history_combo.setEditable(True)
        self.history_combo.setInsertPolicy(QComboBox.NoInsert)
        self.history_combo.setPlaceholderText("Select previous prompt...")
        history_layout.addWidget(self.history_label)
        history_layout.addWidget(self.history_combo)
        image_layout.addLayout(history_layout)
        # Prompt
